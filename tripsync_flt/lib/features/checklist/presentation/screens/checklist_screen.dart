	...
	void initState() {
		...
		_categories = const <ChecklistCategoryData>[
			...
			ChecklistCategoryData(
				...
				items: [
					ChecklistItemData(title: 'Giấy ướt lau mặt', assigneeName: 'Minh Anh'),
													...
													return Padding(
														padding: const EdgeInsets.only(bottom: 41),
															child: ChecklistCategoryCard(
																data: category,
																onItemTap: (itemIndex) => _toggleItem(categoryIndex, itemIndex),
															),
														);
													},
											).toList(),
